	       ...
	       <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="home-tab">
			    ...
			    <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group">
                         ...
                         <input type="tel" class="form-control"  value="<?php if(isset($mob)) { echo $mob;}?>"id="mob" name="mob" required/>
                     </div>
	                 <div class="form-group">
                          <label for="phone">Phone:</label>
                          <input type="tel" class="form-control"  id="phone" value="<?php if(isset($phone)) { echo $phone;}?>"  name="phone" required>
                     </div>
	                 <div class="form-group">
